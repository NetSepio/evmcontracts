...
export interface IEREBRUSMANAGERInterface extends utils.Interface {
  contractName: "IEREBRUSMANAGER";
  functions: {
...
export interface IEREBRUSMANAGER extends BaseContract {
  contractName: "IEREBRUSMANAGER";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEREBRUSMANAGERInterface;

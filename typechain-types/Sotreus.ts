...
export interface SotreusInterface extends utils.Interface {
  contractName: "Sotreus";
  functions: {
    "DEFAULT_ADMIN_ROLE()": FunctionFragment;
    "SOTREUS_ADMIN_ROLE()": FunctionFragment;
    "SOTREUS_OPERATOR_ROLE()": FunctionFragment;
    "WEEK()": FunctionFragment;
    "addManager(address,uint256)": FunctionFragment;
    ...
    "isManager(uint256)": FunctionFragment;
    ...
    "removeManager(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "SOTREUS_ADMIN_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "SOTREUS_OPERATOR_ROLE",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "TokenManagerAdded(uint256,address)": EventFragment;
    "TokenManagerRemoved(uint256,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "TokenManagerAdded"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenManagerRemoved"): EventFragment;
...
export type TokenManagerAddedEvent = TypedEvent<
  [BigNumber, string],
  { tokenId: BigNumber; user: string }
>;

export type TokenManagerAddedEventFilter =
  TypedEventFilter<TokenManagerAddedEvent>;

export type TokenManagerRemovedEvent = TypedEvent<
  [BigNumber, string],
  { tokenId: BigNumber; user: string }
>;

export type TokenManagerRemovedEventFilter =
  TypedEventFilter<TokenManagerRemovedEvent>;
...
export interface Sotreus extends BaseContract {
  contractName: "Sotreus";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SotreusInterface;
  ...
  functions: {
    ...
    SOTREUS_ADMIN_ROLE(overrides?: CallOverrides): Promise<[string]>;

    SOTREUS_OPERATOR_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  isManager(tokenId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    ...
    "TokenManagerAdded(uint256,address)"(
      tokenId?: null,
      user?: null
    ): TokenManagerAddedEventFilter;
    TokenManagerAdded(
      tokenId?: null,
      user?: null
    ): TokenManagerAddedEventFilter;

    "TokenManagerRemoved(uint256,address)"(
      tokenId?: null,
      user?: null
    ): TokenManagerRemovedEventFilter;
    TokenManagerRemoved(
      tokenId?: null,
      user?: null
    ): TokenManagerRemovedEventFilter;
  ...
  estimateGas: {
    ...
    SOTREUS_ADMIN_ROLE(overrides?: CallOverrides): Promise<BigNumber>;

    SOTREUS_OPERATOR_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
